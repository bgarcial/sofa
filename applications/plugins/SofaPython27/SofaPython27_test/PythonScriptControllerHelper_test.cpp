...
#include <SofaPython27/PythonScriptControllerHelper.h>
...
protected:
    ...
    virtual void SetUp()
    {
        static const std::string scenePath = std::string(SOFAPYTHON27_TEST_PYTHON_DIR)+std::string("/test_PythonScriptControllerHelper.py");
