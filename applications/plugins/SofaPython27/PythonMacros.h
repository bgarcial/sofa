...
// déclaration, .h
#define SP_DECLARE_CLASS_TYPE(Type) SOFA_SOFAPYTHON27_API extern PyTypeObject SP_SOFAPYTYPEOBJECT(Type);
...
//#define SP_MESSAGE_BASE( level, msg ) { MAINLOGGER( level, msg, "SofaPython27" ) }
#define SP_MESSAGE_INFO( msg ) msg_info("SofaPython27") << msg;
#define SP_MESSAGE_DEPRECATED( msg ) msg_deprecated("SofaPython27") << msg;
#define SP_MESSAGE_WARNING( msg ) msg_warning("SofaPython27") << msg;
#define SP_MESSAGE_ERROR( msg ) msg_error("SofaPython27") << msg;
#define SP_MESSAGE_EXCEPTION( msg ) msg_fatal("SofaPython27") << msg;
