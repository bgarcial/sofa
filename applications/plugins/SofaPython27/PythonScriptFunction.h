...
class SOFA_SOFAPYTHON27_API PythonScriptFunctionParameter : public ScriptFunctionParameter
{
public:
...
class SOFA_SOFAPYTHON27_API PythonScriptFunctionResult : public ScriptFunctionResult
{
public:
...
class SOFA_SOFAPYTHON27_API PythonScriptFunction : public ScriptFunction
{
public:
