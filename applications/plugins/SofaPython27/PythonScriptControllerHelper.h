...
SOFA_SOFAPYTHON27_API PyObject* PythonScriptController_valueToPyObject(bool param);
SOFA_SOFAPYTHON27_API PyObject* PythonScriptController_valueToPyObject(int param);
SOFA_SOFAPYTHON27_API PyObject* PythonScriptController_valueToPyObject(unsigned int param);
SOFA_SOFAPYTHON27_API PyObject* PythonScriptController_valueToPyObject(double param);
SOFA_SOFAPYTHON27_API PyObject* PythonScriptController_valueToPyObject(std::string const& param);

SOFA_SOFAPYTHON27_API void PythonScriptController_pyObjectToValue(PyObject* pyObject, bool & val);
SOFA_SOFAPYTHON27_API void PythonScriptController_pyObjectToValue(PyObject* pyObject, int & val);
SOFA_SOFAPYTHON27_API void PythonScriptController_pyObjectToValue(PyObject* pyObject, unsigned int & val);
SOFA_SOFAPYTHON27_API void PythonScriptController_pyObjectToValue(PyObject* pyObject, float & val);
SOFA_SOFAPYTHON27_API void PythonScriptController_pyObjectToValue(PyObject* pyObject, double & val);
SOFA_SOFAPYTHON27_API void PythonScriptController_pyObjectToValue(PyObject* pyObject, std::string & val);
