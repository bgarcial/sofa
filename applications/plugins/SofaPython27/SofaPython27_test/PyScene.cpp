...
#include <SofaPython27/PythonScriptController.h>
...
struct PyScene_test : public ::testing::Test
{
    ...
    {
        static const std::string scenePath = std::string(SOFAPYTHON27_TEST_PYTHON_DIR)+std::string("/test_PySceneWithPyCtlr.py");
    ...
    {
        static const std::string scenePath = std::string(SOFAPYTHON27_TEST_PYTHON_DIR)+std::string("/test_XmlSceneWithPyCtlr.scn");
        //std::cout<<scenePath<<std::endl;
