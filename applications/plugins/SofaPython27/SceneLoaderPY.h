...
class SOFA_SOFAPYTHON27_API SceneLoaderPY : public SceneLoader
{
public:
    /// Pre-loading check
...
void SOFA_SOFAPYTHON27_API exportPython( Node* node, const char* fileName=NULL );



/// Visitor that exports all nodes/components in python
class SOFA_SOFAPYTHON27_API PythonExporterVisitor : public Visitor
{
